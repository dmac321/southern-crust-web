    ...
    <main className="about-page">
      ...
      <section className="about-content">
        ...
        <ol>
          ...
          <li>Place your order at least 48 hours before your desired pickup/delivery date.</li>
          <li>We'll confirm your order and reach out with pickup details or delivery window.</li>
          <li>Enjoy fresh-baked goods made just for you.</li>
        </ol>
        <h2>Contact</h2>
        <p>
